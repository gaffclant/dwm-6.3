...
static const char *fonts[]          = { "Fantasque Sans Mono:style=Regular:size=22:antialiasing=true", "FontAwesome:size=18:antialiasing=true", };
static const char dmenufont[]       = "Fantasque Sans Mono:style=Regular:size=24";
